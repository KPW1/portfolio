...
let si = 0;
function Slide() {
  $(".skills_img img").eq(si).removeClass("active");
  si++; //

  if (si >= $(".skills_img img").length) {
    si = 0;
  }
  $(".skills_img img").eq(si).addClass("active");
}
      ...
      function (require, module, exports) {
        ...
        var getMousePos = function getMousePos(e) {
          ...
          if (e.screenX || e.screenY) {
            ...
            posx =
              e.screenX + body.scrollLeft + document.documentElement.scrollLeft;
            posy =
              e.screenY + body.scrollTop + document.documentElement.scrollTop;
          }
...
*/
    ...
    Jy3L: [
            ...
            },
            {
              ...
              value: function render() {
                ...
                this.animatableProperties.brightness.current = this
                  .firstRAFCycle
                  ? 1
                  : (0, _utils.map)(mouseDistanceX, 0, 100, 1, 4); // set up the interpolated values
      ...
      { gsap: "TpQl", "./utils": "MgTz", "../img/*.jpg": "m7Bz" },
    ],
    i0CD: [
      function (require, module, exports) {
        "use strict";
